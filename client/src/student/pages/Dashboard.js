    ...
    <Box sx={{ backgroundColor: "#ffffff", height: "100%" }}>
      ...
      <List>
        {[
          {
            text: "Dashboard",
            icon: <DashboardIcon sx={{ color: "#3f51b5" }} />,
            to: "/student",
          },
          {
            text: "My Profile",
            icon: <ProfileIcon sx={{ color: "#3f51b5" }} />,
            to: "/student/profile",
          },
          {
            text: "Course Enrollment",
            icon: <CourseIcon sx={{ color: "#3f51b5" }} />,
            to: "/student/courses",
          },
          {
            text: "Available Exams",
            icon: <ExamIcon sx={{ color: "#3f51b5" }} />,
            to: "/student/exams",
          },
          {
            text: "My Results",
                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      value: dashboardData.stats.averageScore
                        ? `${dashboardData.stats.averageScore.toFixed(2)}%`
                        : "N/A",
                      icon: <DashboardIcon />,
                    },
                  ].map((stat, index) => (
