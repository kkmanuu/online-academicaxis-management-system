                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {stats.performanceStats.averageScore.toFixed(2)}%
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Pass Rate</TableCell>
                    <TableCell align="right">
                      {stats.performanceStats.passRate.toFixed(2)}%
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Fail Rate</TableCell>
                    <TableCell align="right">
                      {stats.performanceStats.failRate.toFixed(2)}%
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
