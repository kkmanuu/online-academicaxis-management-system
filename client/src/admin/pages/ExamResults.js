            ...
            <TableBody>
              {filteredResults.map((result) => (
                <TableRow key={result._id} hover>
                  ...
                  <TableCell>
                    {result.exam?.course?.name || "Unknown"}
                  </TableCell>
          ...
          {selectedResult && (
            <Grid container spacing={3} sx={{ mt: 1 }}>
              <Grid item xs={12}>
                ...
                <Typography>
                  <strong>Name:</strong>{" "}
                  {selectedResult.student?.name || "Unknown"}
                </Typography>
                <Typography>
                  <strong>Email:</strong>{" "}
                  {selectedResult.student?.email || "Unknown"}
                </Typography>
              </Grid>
              <Grid item xs={12}>
                <Typography
                ...
                <Typography>
                  <strong>Title:</strong>{" "}
                  {selectedResult.exam?.title || "Unknown"}
                </Typography>
                <Typography>
                  <strong>Course:</strong>{" "}
                  {selectedResult.exam?.course?.name || "Unknown"}
                </Typography>
                <Typography>
                  <strong>Teacher:</strong>{" "}
                  {selectedResult.exam?.teacher?.name || "Unknown"}
                </Typography>
              </Grid>
            </Grid>
          )}
